...
## 重啟github
  睽違兩年打開github了，時代變遷與興趣使然，我回到了土木工程界。近期要執行一個有點瘋的計畫—開始寫小說。<br/>
  這幾年發生了什麼事情有空在README.md再作解釋。目前我的github頁面轉型為小說與散文的版次管理用，原則上不會有公開的完整著作在這裡釋出。有機緣的話也會嘗試AI時代較有效率的程式開發方式<br/>
  興許龜時鱉日，我也會把數值分析專案中「數值積分」還有「非線性方程式求解」這兩部分的數學原理接續寫完吧!<br/>
  -2026/2/11<br>
  ***
  畫條線看看我以前是幹嘛的<br>
  ***
各位好，我主修土木工程研究所就讀資訊科技組。
* 有興趣的領域
...
* 程式以外工作經驗：
  * 2021-2022年就任土木工程類科之公務人員，從事風景區設施維護管理、土木工程標案與履約管理、並曾撰寫智慧公廁標案(運用物聯網設備即時監測公廁清潔狀況與備品補給)。
